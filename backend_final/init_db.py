...
# Данные из .env
NEW_USER = os.getenv('DB_USER', 'backend_app')
NEW_PASS = os.getenv('DB_PASS', 'qoziwe')
NEW_DB = os.getenv('DB_NAME', 'eventummobile')

# Суперпользователь PostgreSQL (измените пароль!)
ROOT_USER = "postgres"
